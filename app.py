...
"彼得提爾": {
        ...
        "philosophy": (
            "從0到1的創新、壟斷思維、逆向思考、冪次法則。"
            "競爭是失敗者的遊戲，真正的利潤來自壟斷。"
            "尋找能創造全新市場的公司，而非在既有市場中競爭的公司。"
        ),
        "key_principles": [
            "從0到1：尋找創造全新事物的公司，而非複製既有模式",
            "壟斷思維：最好的企業是某個利基市場的壟斷者",
            "冪次法則：少數公司創造絕大部分回報",
            "逆向思考：問「有什麼重要的事是大多數人不同意你的？」",
            "技術護城河：專有技術必須比最接近的替代方案好10倍",
        ],
        "source": "NotebookLM — Peter Thiel 知識庫 (3 sources)",
    },
    "科斯托蘭尼": {
        "emoji": "🎭",
        "notebook_id": "1a101582-8f24-45ec-b7da-930f37f95dda",
        "philosophy": (
            "雞蛋理論、人心與資金、固執投資人vs猶豫投資人。"
            "股市短期是投票機，長期是秤重機。"
            "投機是一門藝術，不是科學。"
        ),
        "key_principles": [
            "雞蛋理論：股市循環如同雞蛋——從固執投資人手中到猶豫投資人手中",
            "人心與資金：股市取決於資金與人心，資金寬鬆+樂觀=上漲",
            "固執投資人：有遠見、有耐心、有資金的投資人最終獲勝",
            "逆向操作：在絕望中買入，在歡樂中賣出",
            "不要借錢投資：能承受虧損才能保持理性判斷",
        ],
        "source": "NotebookLM — André Kostolany 知識庫 (2 sources)",
    },
}
